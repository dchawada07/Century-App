...
for (const required of ['TransportOS', 'Create Trip', 'Control Tower', 'Mark Empty/Available', 'Fuel Transactions Stub', 'Login / Forgot Password', 'WheelsEye GPS simulator', 'Spec coverage checklist']) {
